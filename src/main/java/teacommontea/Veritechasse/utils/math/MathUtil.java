...
package teacommontea.veritechasse.utils.math;
...
public final class MathUtil {
    ...
    public static final int PACKED_HORIZONTAL_LENGTH = 1 + MathUtil.log2(MathUtil.smallestEncompassingPowerOfTwo(30000000));
    ...
    @Contract(pure = true)
    public static long asLong(Vec3i vector) {
